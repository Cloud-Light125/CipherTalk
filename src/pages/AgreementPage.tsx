  ...
  return (
    <div className="agreement-page">
      ...
      <ScrollShadow className="agreement-content" size={72}>
        <h2>CloudLight WeChat 软件用户协议与隐私政策</h2>
        <p>欢迎您使用“CloudLight WeChat”桌面软件（以下简称“本软件”）。在下载、安装、使用本软件之前，请您务必仔细阅读并充分理解本《软件用户协议与隐私政策》（以下简称“本协议”）。一旦您安装、使用本软件，即视为您已阅读、理解并同意接受本协议的全部条款。如您不同意本协议的任何内容，请立即停止使用本软件。</p>
        ...
        <h3>3. 网络请求说明</h3>
        <p>3.1 本软件不会在后台访问网络检查软件版本或自动下载更新。只有在用户主动使用第三方 AI、模型列表、资源、MCP 或其他网络集成功能时，才会向用户选择的服务地址发起必要请求。</p>
        <p>3.2 上述网络请求仅用于完成用户主动发起的功能，不会上传与该功能无关的聊天数据、设备数据或使用行为数据。</p>
