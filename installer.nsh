...
!macro customWelcomePage
  !define MUI_WELCOMEPAGE_TITLE "欢迎安装 CloudLight WeChat"
  !define MUI_WELCOMEPAGE_TEXT "CloudLight WeChat 是一款安全的本地聊天记录工具。$\r$\n$\r$\n数据完全存储在本地，隐私尽在掌握。$\r$\n$\r$\n点击「下一步」开始安装。"
  !insertmacro MUI_PAGE_WELCOME
!macroend

; 自定义完成页（文案 + 保留“运行 CloudLight WeChat”勾选框）
!macro customFinishPage
  ...
  !define MUI_FINISHPAGE_RUN_TEXT "立即启动 CloudLight WeChat"
  !define MUI_FINISHPAGE_TITLE "安装完成"
  !define MUI_FINISHPAGE_TEXT "CloudLight WeChat 已成功安装到你的电脑。$\r$\n$\r$\n点击「完成」关闭向导，开始使用。"
