...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  deviceConnect: {
    ...
    remote: {
      ...
      getPushConfig: () => ipcRenderer.invoke('deviceConnect:remote:getPushConfig') as Promise<{ success: boolean; configured: boolean; keyId: string; teamId: string; deviceCount: number }>,
